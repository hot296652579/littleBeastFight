System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, SitDownDTO, StartGameDTO, OperationNotifyDTO, MoveResultDTO, OpenResultDTO, EndGameDTO, ConfirmColorDTO, AiEngine, FireKit, Config, GameEngine, _crd;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      AiEngine = _unresolved_9.default;
    }, function (_unresolved_10) {
      FireKit = _unresolved_10.default;
    ...
    execute: function () {
      ...
      _export("default", GameEngine = class GameEngine {
        ...
        startGame() {
          this.cards = this.shuffle(); // this.currChair = _.random(0, GameEngine.MAX_CHAIR - 1, false); // 随机生成第一个操作的椅子
        ...
        sendStartGame() {
          for (let key in this.players) {
            this.players[key].startGame(new (_crd && StartGameDTO === void 0 ? (_reportPossibleCrUseOfStartGameDTO({
              error: Error()
        ...
        sendSitDown(chair, player) {
          for (let key in this.players) {
            this.players[key].sitDown(new (_crd && SitDownDTO === void 0 ? (_reportPossibleCrUseOfSitDownDTO({
              error: Error()
        ...
        sendOpenResult(chair, index, card) {
          for (let key in this.players) {
            this.players[key].openResult(new (_crd && OpenResultDTO === void 0 ? (_reportPossibleCrUseOfOpenResultDTO({
              error: Error()
        ...
        sendMoveResult(chair, fromIndex, fromCard, toIndex, toCard, result) {
          for (let key in this.players) {
            this.players[key].moveResult(new (_crd && MoveResultDTO === void 0 ? (_reportPossibleCrUseOfMoveResultDTO({
              error: Error()
        ...
        sendOperationNotify() {
          ...
          for (let key in this.players) {
            this.players[key].operationNotify(new (_crd && OperationNotifyDTO === void 0 ? (_reportPossibleCrUseOfOperationNotifyDTO({
              error: Error()
        ...
        sendEndGame() {
          ...
          for (let key in this.players) {
            this.players[key].endGame(new (_crd && EndGameDTO === void 0 ? (_reportPossibleCrUseOfEndGameDTO({
              error: Error()
        ...
        sendConfirmColor(chair, color) {
          for (let key in this.players) {
            this.players[key].confirmColor(new (_crd && ConfirmColorDTO === void 0 ? (_reportPossibleCrUseOfConfirmColorDTO({
              error: Error()
...
//# sourceMappingURL=a79dc91f74d769d259978ea109721126663b20e0.js.map