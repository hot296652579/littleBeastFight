    ...
    execute: function () {
      ...
      _export("UIBattle", UIBattle = (_dec = ccclass('UIBattle'), _dec2 = property(Node), _dec3 = property(Sprite), _dec4 = property({
        ...
        async updateStyle(index, card) {
          let cardTemp = this.getCardItemTemp(index); // let UICardCom = cardTemp.getChildByName('Sprite').getComponent(UICard)
...
//# sourceMappingURL=733cc4d6d97e9d47784c63948cf757d28f0b3b04.js.map