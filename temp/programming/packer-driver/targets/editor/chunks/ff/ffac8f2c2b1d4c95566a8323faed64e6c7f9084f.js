    ...
    execute: function () {
      ...
      _export("BattleLogic", BattleLogic = class BattleLogic extends (_crd && BaseLogic === void 0 ? (_reportPossibleCrUseOfBaseLogic({
        ...
        async startLoadGame() {
          ...
          await (_crd && UIBattleMgr === void 0 ? (_reportPossibleCrUseOfUIBattleMgr({
            error: Error()
          }), UIBattleMgr) : UIBattleMgr).Instance().showLoading();
          let resType = new Map();
...
//# sourceMappingURL=ffac8f2c2b1d4c95566a8323faed64e6c7f9084f.js.map