    ...
    execute: function () {
      ...
      _export("UIBattle", UIBattle = (_dec = ccclass('UIBattle'), _dec2 = property({
        ...
        startGameLogic(startGameVo) {
          console.log('this.node.getChildByName(`top`)' + this.node.getChildByName('Top'));
          this.cards = startGameVo.cards;
          this._locked = startGameVo.chair != this._meChair;

          for (var index = 0; index < (_crd && GameEngine === void 0 ? (_reportPossibleCrUseOfGameEngine({
            error: Error()
            ...
            var button = this.node.getChildByName('Games').getChildByName('Card' + index).addComponent(Button);
...
//# sourceMappingURL=0322976047be680e4fc916fd473fcd5523ed2071.js.map