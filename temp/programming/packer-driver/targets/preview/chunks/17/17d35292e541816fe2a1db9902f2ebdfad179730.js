        ...
        clickBtnFight() {
          return _asyncToGenerator(function* () {
            ...
            yield (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              error: Error()
            }), ResMgr) : ResMgr).getInstance().preloadBundleOnly('Battle'); // await ResMgr.getInstance().preloadBundlePrefab('Battle/Prefabs/UIBattleLoading');
...
//# sourceMappingURL=17d35292e541816fe2a1db9902f2ebdfad179730.js.map