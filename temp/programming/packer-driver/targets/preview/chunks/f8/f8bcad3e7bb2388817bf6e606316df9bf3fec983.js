System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Label, ProgressBar, EventMgr, FBGameEventName, UIWindow, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, UIBattleLoading;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIBattleLoading", UIBattleLoading = (_dec = ccclass('UIBattleLoading'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class UIBattleLoading extends (_crd && UIWindow === void 0 ? (_reportPossibleCrUseOfUIWindow({
        error: Error()
      }), UIWindow) : UIWindow) {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=f8bcad3e7bb2388817bf6e606316df9bf3fec983.js.map