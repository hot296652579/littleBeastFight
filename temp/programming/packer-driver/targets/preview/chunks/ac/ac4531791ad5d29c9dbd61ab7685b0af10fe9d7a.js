System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Label, ProgressBar, EventMgr, FBGameEventName, UIWindow, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, UIBattleLooading;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIBattleLooading", UIBattleLooading = (_dec = ccclass('UIBattleLooading'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class UIBattleLooading extends (_crd && UIWindow === void 0 ? (_reportPossibleCrUseOfUIWindow({
        error: Error()
      }), UIWindow) : UIWindow) {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=ac4531791ad5d29c9dbd61ab7685b0af10fe9d7a.js.map