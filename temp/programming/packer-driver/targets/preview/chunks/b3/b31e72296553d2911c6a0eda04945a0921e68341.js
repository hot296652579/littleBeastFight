System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Button, Component, EventMgr, LogicEvent, UIScreen, Config, MoveCardDTO, OpenCardDTO, FireKit, GameEngine, GameEvent, HumanPlayer, PlayerManager, TweenUtil, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, UIBattle;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      TweenUtil = _unresolved_13.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("UIBattle", UIBattle = (_dec = ccclass('UIBattle'), _dec2 = property(Node), _dec3 = property({
        ...
        updateOpenCard(openResultVO) {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield (_crd && TweenUtil === void 0 ? (_reportPossibleCrUseOfTweenUtil({
              error: Error()
            }), TweenUtil) : TweenUtil).flip(cardTemp, 0.8, () => {
        ...
        updateStyle(index, card) {
          var cardTemp = this.getCardItemTemp(index);
        }
        /**
         * 增加选择状态
         * @param index
...
//# sourceMappingURL=b31e72296553d2911c6a0eda04945a0921e68341.js.map