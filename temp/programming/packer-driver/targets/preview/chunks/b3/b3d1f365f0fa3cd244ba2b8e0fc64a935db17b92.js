System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Button, Component, Sprite, EventMgr, ResMgr, LogicEvent, UIScreen, Config, MoveCardDTO, OpenCardDTO, FireKit, GameEngine, GameEvent, HumanPlayer, PlayerManager, UICard, TweenUtil, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, UIBattle;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      MoveCardDTO = _unresolved_7.default;
    }, function (_unresolved_8) {
      OpenCardDTO = _unresolved_8.default;
    }, function (_unresolved_9) {
      FireKit = _unresolved_9.default;
    }, function (_unresolved_10) {
      GameEngine = _unresolved_10.default;
    }, function (_unresolved_11) {
      GameEvent = _unresolved_11.default;
    }, function (_unresolved_12) {
      HumanPlayer = _unresolved_12.default;
    }, function (_unresolved_13) {
      PlayerManager = _unresolved_13.default;
    }, function (_unresolved_14) {
      UICard = _unresolved_14.default;
    }, function (_unresolved_15) {
      TweenUtil = _unresolved_15.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("UIBattle", UIBattle = (_dec = ccclass('UIBattle'), _dec2 = property(Node), _dec3 = property(Sprite), _dec4 = property({
        type: [Node]
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "test", _descriptor2, this);
          ...
          _initializerDefineProperty(this, "btnCards", _descriptor3, this);
        ...
        onShow() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var icon = yield (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              error: Error()
            }), ResMgr) : ResMgr).getInstance().getSpriteFrameByPath('Battle/Texture/animal/lion.png');
            _this.test.spriteFrame = icon;
          })();
        }
        ...
        updateOpenCard(openResultVO) {
          var _this2 = this;

          return _asyncToGenerator(function* () {
            console.log('openResultVO', openResultVO);
            var card = openResultVO.card;
            var index = openResultVO.index;

            var cardTemp = _this2.getCardItemTemp(index);

            yield (_crd && TweenUtil === void 0 ? (_reportPossibleCrUseOfTweenUtil({
              error: Error()
            }), TweenUtil) : TweenUtil).flip(cardTemp.getChildByName('Sprite'), 0.8, () => {
              _this2.updateStyle(index, card);
            });
          })();
        }

        getCardItemTemp(index) {
          for (var i = 0; i < this.btnCards.length; i++) {
            var element = this.btnCards[i];
        ...
        updateStyle(index, card) {
          var _this3 = this;

          return _asyncToGenerator(function* () {
            var cardTemp = _this3.getCardItemTemp(index); // let UICardCom = cardTemp.getChildByName('Sprite').getComponent(UICard)
            // UICardCom.refreshSprite(card)


            var icon = yield (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
              error: Error()
            }), ResMgr) : ResMgr).getInstance().getSpriteFrameByPath('Battle/Texture/animal/lion');
        ...
        clearSelectStyle() {
          for (var i = 0; i < (_crd && GameEngine === void 0 ? (_reportPossibleCrUseOfGameEngine({
            error: Error()
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "test", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "btnCards", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=b3d1f365f0fa3cd244ba2b8e0fc64a935db17b92.js.map