System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Button, Component, Sprite, EventMgr, LogicEvent, UIScreen, Config, MoveCardDTO, OpenCardDTO, FireKit, GameEngine, GameEvent, HumanPlayer, PlayerManager, UICard, TweenUtil, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, UIBattle;
      ...
      _export("UIBattle", UIBattle = (_dec = ccclass('UIBattle'), _dec2 = property(Node), _dec3 = property(Sprite), _dec4 = property({
        ...
        eventRegister() {
          ...
          (_crd && FireKit === void 0 ? (_reportPossibleCrUseOfFireKit({
            ...
            error: Error()
          }), GameEvent) : GameEvent).OPERATION_NOTIFY, this.operationNotifyLogic, this); // FireKit.use(Config.HUMAN_FIRE).onGroup(GameEvent.MOVE_RESULT, this.moveResultLogic, this);
        ...
        updateStyle(index, card) {
          ...
          return _asyncToGenerator(function* () {
            var cardTemp = _this3.getCardItemTemp(index);

            var UICardCom = cardTemp.getChildByName('Sprite').getComponent(_crd && UICard === void 0 ? (_reportPossibleCrUseOfUICard({
              error: Error()
            }), UICard) : UICard);
...
//# sourceMappingURL=c91da3537ba0c66e58c304294967fc70964b14f0.js.map